...
class Kk_MailchimpSync extends Module
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'kk_mailchimpsync';
        ...
        $this->displayName = $this->trans('Mailchimp Sync', array(), 'Modules.MailchimpSync.Admin');
        $this->description = $this->trans('Synchornize newsletter emails to mailchimp.', array(), 'Modules.MailchimpSync.Admin');
    }
